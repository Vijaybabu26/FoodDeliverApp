...
public class Payment {
	...
	public Payment(Integer paymentId, User userId, Order ordereId, LocalDateTime paymentdate, double amount,
	...
	public Order getOrdereId() {
		return ordereId;
	}

	public void setOrdereId(Order ordereId) {
		this.ordereId = ordereId;
	}
